alter table public.document_analyses
  ...
  add column if not exists payment_score numeric(5,2) default 0,
...
create index if not exists document_analyses_demand_idx on public.document_analyses(demand_score desc);
create index if not exists document_analyses_pain_idx on public.document_analyses(pain_score desc);
create index if not exists document_analyses_payment_idx on public.document_analyses(payment_score desc);
