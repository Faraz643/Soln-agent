...
export async function GET(request: NextRequest) {
  ...
  // Legacy records created before the quality gate are deliberately hidden from
  // the autonomous output. They remain in the database for history, but must not
  // be presented as freshly validated product opportunities.
