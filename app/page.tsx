...
export default async function Home() {
  ...
  return <AppShell active="Overview"><div className="content">
    ...
    <p className="lead">Soln-Agent generates research areas, searches public conversations, detects recurring problems, measures demand, researches competition and ranks product opportunities. You do not need to choose the market first.</p>
